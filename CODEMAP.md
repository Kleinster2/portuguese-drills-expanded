...
- **`functions/api/chat.js:104-186`** - callClaude() function with retry logic
...
33-102      getDrillPrompt() - Adds randomization + chip instructions
...
- **PROJECT_README.md** - High-level architecture and concepts
