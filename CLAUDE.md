...
### Atomic Focus
Each drill should target ONE specific concept. When in doubt, split rather than combine.

**Examples:**
- Saber vs Conhecer → one drill (single distinction)
- Aspectual shifts (saber, conhecer, poder, querer) → four separate drills, not one combined
- Pôr derivatives → one drill (single pattern applied to many verbs)

**Rationale:**
- Focused practice builds stronger retention
- Learners can target specific weaknesses
- Progress tracking is more granular
- Drills can be combined in multi-drill sessions when broader practice is needed
