...
- **`config/prompts/*.json`** - 131 individual drill configs
...
- **`utils/promptData.generated.js`** - Generated file (DO NOT EDIT DIRECTLY)
- **`scripts/build-prompts.js`** - Syncs JSON → promptData.generated.js
...
#### **`utils/promptData.generated.js`** (Generated - DO NOT EDIT)
- Auto-generated by `scripts/build-prompts.js`
- Contains all 131 drill configurations embedded
- File size: ~446 KB
...
#### **`config/prompts/*.json`** (131 Drill Configs)
...
Generates utils/promptData.generated.js
Reports errors (shows position and line)
```

**Running:**
```bash
npm run build    # Syncs JSON to promptData.generated.js
```

**Output:**
```
Found 131 prompt files
✓ Loaded ser-estar.json (ser-estar)
✗ Skipping bad-file.json: Expected ',' or '}' after property value...
✅ Successfully updated promptData.generated.js with 131 prompts
```
...
**Check what's in the generated bundle:**
```bash
# Shows all loaded drills
grep "Loaded.*json" utils/promptData.generated.js
```
