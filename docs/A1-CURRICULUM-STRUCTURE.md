...
1. **ATOMIC UNITS** - One topic per unit. Split when content covers multiple concepts.

2. **SINGULAR BEFORE PLURAL** - Students master production tools in singular (eu, ele/ela, você) before introducing plural forms (nós, eles/elas, vocês).

3. **PRODUCTION FIRST** - Introduce useful vocabulary words before formal grammar patterns. Students produce as soon as possible.

4. **CONCRETE BEFORE ABSTRACT** - Location (where you are) before feelings (how you feel).

5. **PRONOUN PROGRESSION** - eu → (drop eu) → ele/ela → você → (later: nós, eles/elas, vocês)

6. **VOCABULARY SERVES PRODUCTION** - No vocabulary for vocabulary's sake. Every word introduced enables a specific production goal.

7. **CULTURAL RELEVANCE**
   - Age: People rarely state their age in conversation. Low priority.
   - Hunger/thirst: Use "estou com fome/sede" not "tenho fome/sede"

8. **PRONOUN REPETITION** - When joining sentences with "e", repeating the pronoun is never required but patterns differ:
   - **eu/nós**: repetition uncommon in all cases
     - Sou brasileiro e moro em São Paulo (typical)
   - **ele/ela/eles/elas**: repetition common, except before ser/estar
     - Ele é brasileiro e é professor (repeat uncommon)
     - Ele é brasileiro e ele mora em São Paulo (repeat common)
     - Ele é brasileiro e mora em São Paulo (also correct)
...
──────┼──────────────────────┼─────────────────────────────────────────
      │ SECTION 1: EU        │
──────┼──────────────────────┼─────────────────────────────────────────
  1   │ Say Your Name        │ olá, eu sou o/a + name
  2   │ Say Your Nationality │ eu sou + nationality
  3   │ Your Profession      │ eu sou + profession
  4   │ Contractions de      │ de/do/da/dos/das
  5   │ Say Where You're From│ eu sou de/do/da/dos/das + origin
  6   │ Contractions em      │ em/no/na/nos/nas
  7   │ Where You Live (City)│ eu moro em + city
  8   │ Where You Live (Street)│ eu moro na rua/avenida
  9   │ What You Like        │ eu gosto de
 10   │ Where/What You Work  │ eu trabalho com/em/no/na
 11   │ Numbers 1-5          │ um/uma, dois/duas, três, quatro, cinco
 12   │ What You Have        │ eu tenho
 13   │ Where You Are        │ eu estou em/no/na/nos/nas + location
 14   │ How You Feel         │ eu estou + feelings
──────┼──────────────────────┼─────────────────────────────────────────
      │ SECTION 2: DROP EU   │
──────┼──────────────────────┼─────────────────────────────────────────
 15   │ Say Your Name        │ olá, sou o/a + name
 16   │ Say Your Nationality │ sou + nationality
 17   │ Your Profession      │ sou + profession
 18   │ Say Where You're From│ sou de/do/da/dos/das + origin
 19   │ Where You Live (City)│ moro em + city
 20   │ Where You Live (Street)│ moro na rua/avenida
 21   │ What You Like        │ gosto de
 22   │ Where/What You Work  │ trabalho com/em/no/na
...
──────┼──────────────────────┼─────────────────────────────────────────
 ...
 68   │ Where We Live        │ nós moramos em + city/street
 69   │ What We Like         │ nós gostamos de
 70   │ Where We Work        │ nós trabalhamos em/no/na
 71   │ What We Have         │ nós temos
...
──────┼──────────────────────┼─────────────────────────────────────────
 ...
 76   │ Where We Live        │ moramos em + city/street
 77   │ What We Like         │ gostamos de
 78   │ Where We Work        │ trabalhamos em/no/na
 79   │ What We Have         │ temos
...
──────┼──────────────────────┼─────────────────────────────────────────
 ...
 88   │ Where They Live      │ eles/elas moram em + city/street
 89   │ What They Like       │ eles/elas gostam de
 90   │ Where They Work      │ eles/elas trabalham em/no/na
 91   │ What They Have       │ eles/elas têm
...
100   │ Vocês - Location     │ Q: onde vocês moram? A: moramos em...
