# Colloquial Portuguese Reference

Source: [ClawHub — Portuguese skill by @ivangdavila](https://clawhub.ai/ivangdavila/portuguese)
License: MIT-0

A style guide for writing natural, human-sounding Portuguese instead of stiff AI-generated text. Useful as a reference for teaching materials and for calibrating how natural our drills and examples sound.

---

## The Real Problem

AI Portuguese is technically correct but sounds off. Too formal. Too stiff. Natives write with more warmth, contractions, and regional flavor.

## Formality

Default register is too high. Casual Portuguese is warm and direct. Unless explicitly formal:
- "Oi" not "Olá"
- "Tá" not "Está bem"
- "Valeu" not "Obrigado"
